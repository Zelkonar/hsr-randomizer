const styles = {
    ...
    buttonActive: "border-sky-500/50 shadow-[0_0_28px_rgba(14,165,233,0.22)] hover:border-sky-400/60 hover:bg-sky-500/10 hover:text-sky-300 hover:shadow-lg hover:shadow-sky-500/20 active:border-sky-400/60 active:bg-sky-500/10 active:text-sky-300 active:shadow-lg active:shadow-sky-500/20 active:scale-95",
...
export function RandomizeButton({
    ...
    return (
        <div className={styles.wrapper}>
            ...
            {disabledReason && (
                <p className={styles.errorText}>{disabledReason}</p>
            )}
        </div>
    );
}

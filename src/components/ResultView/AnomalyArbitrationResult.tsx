        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-col gap-6">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">
                    ...
                    <TeamView team={knights[1]} label="Knight 2" isInRoster={isInRoster} layout="knight" />
                    <TeamView team={knights[2]} label="Knight 3" isInRoster={isInRoster} layout="knight" />
                </div>
                <TeamView team={king} label="King" isInRoster={isInRoster} layout="half" />
            </div>
        </div>
    );
}
